...
angular.module(
    "ngHtmlBuilder",
    []
    ).directive(ngHtmlBuilderModule.ngIncludeOnce,function($compile,$templateRequest){return {
        restrict:"E",
        priority: 1000,
            ...
            if (!attrs.src) {
                ...
                m.addPromise(function(){
                    return(m.sha256(data.html).then(function(hash){
                        ...
                        if (replace){
                            var template=angular.element(data.html);
        ...
        link:function(scope,element,attrs,controller,transcludeFn){
            ...
            m.addPromise(function(){
                ...
                if (angular.isUndefined(attrs[m.ngSelector])) {
                    ...
                    template=angular.element(template_html);
